...
import com.devsuperior.dscatalogsrt3.tests.TokenUtil;
...
//	}																   //exemplo: .andExpect(status().isOk())
	...
	//Para efeito didatico o formatod abaixo é melhor (legibilidade melhor dos Asserts pra quem está aprendendo)
	@Test
	public void findAllShouldReturnPage() throws Exception {
